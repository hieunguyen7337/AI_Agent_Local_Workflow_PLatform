...
- `docs/session_handoff_2026-05-05.md` - latest person_reid handoff: map_cmc-shared filtered-rank helpers, disagreement counts at K={1,5,10,20}, CMC@20 ablation headline, and description DB model defaults.
