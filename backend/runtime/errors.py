...
class PendingSubgraphApprovalError(WorkflowError):
    def __init__(self, pending: dict, state_update: dict | None = None):
        super().__init__(f"pending subgraph approval at node {pending.get('node_id')!r}")
